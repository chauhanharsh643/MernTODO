...
const Navbar = () => {
  ...
  return (
        ...
        <div className="container-fluid">
            <Link className="navbar-brand" to="/"><b><GiSecretBook />TODO</b></Link>
